...
- Use automated systems (bots, scrapers, etc.) to access the website without permission

We reserve the right to suspend or terminate access to the website for users who violate these Terms.
...
Joining a waitlist or providing contact information does not guarantee access to future services.
...
- Non-infringement
- Availability or uninterrupted operation of the website
...
This includes but is not limited to loss of data, loss of business, or financial losses.
...
We are not liable for any modification or discontinuation of the website or its services.

## 8. Changes to These Terms

We may update these Terms of Service from time to time.

When changes occur, the updated version will be posted on this page with the revised "Last Updated" date.
